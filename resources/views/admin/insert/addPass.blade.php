                                        ...
                                        <div class="card-body">
                                            ...
                                            <form action="" method="post" enctype="multipart/form-data">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="number" name="phone_number" class="form-control @error ('phone_number') is valaid @enderror" value="{{old('phone_number')}}">
                                                    @error('phone_number')
                                                        <p class="text-danger small">{{$message}}</p>
                                                    @enderror
                                                </div>
                                                <div class="mb-3">
                                                    <label for="">p_image</label>
                                                ...
                                                <div class="mb-3">
                                                    <label for="">DOB </label>
                                                    <input type="date" name="dob" class="form-control @error ('dob') is valaid @enderror" value="{{old('dob')}}">
                                                    @error('dob')
                                                        <p class="text-danger small">{{$message}}</p>
                                                    @enderror
                                                </div>
